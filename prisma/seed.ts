...
async function main() {
  ...
  const siteSettings = [
    ...
    { key: 'domain', value: 'https://parcaesyadepolama.com.tr' },
    ...
    { key: 'faq_description', value: 'Depolama süresi, sigorta kapsamı, erişim kuralları ve teslimat planlarına dair sık sorulan soruları sade ve güven veren cevaplarla bir araya getirdik.' },
    { key: 'areas_description', value: 'İstanbul merkezli operasyonumuz Marmara’dan Ege’ye uzanan depolama ve teslimat ağımızla eşyalarınızı bulunduğunuz noktadan teslim alıp güvenle saklar.' },
    { key: 'partners_description', value: 'Kurumsal çözüm ortaklarımız, düzenli stok yönetimi ve planlı teslimatlar için sunduğumuz yüksek servis seviyesinin sürdürülebilirliğini gösterir.' },
    { key: 'quote_title', value: 'Hızlı Teklif Alın' },
    { key: 'quote_description', value: 'Bilgilerinizi aldıktan sonra en kısa sürede sizinle iletişime geçeceğiz.' },
    { key: 'quote_hero_subtitle', value: '2 Dakikada Ücretsiz Fiyat Teklifi' },
    { key: 'quote_hero_note', value: 'Tahmini fiyatlardır. Lütfen doğru fiyat için ekibimizle iletişime geçin.' },
    { key: 'blog_description', value: 'Depoda saklama ipuçları, nem kontrolü önerileri ve eşyalarınızı uzun süre korumanın yollarını blog içeriklerimizde paylaşıyoruz.' },
    { key: 'seo_title', value: 'Evden Eve Nakliyat - Profesyonel Taşımacılık' },
    { key: 'seo_description', value: 'İklim kontrollü depolarımızda sigortalı saklama, paketleme ve düzenli raporlama ile eşya depolama ihtiyaçlarını hızlı ve güvenilir şekilde karşılıyoruz.' },
    { key: 'page_desc_iletisim', value: 'Depo planlama ekibimiz, saklama süresi ve teslimat tercihlerinize göre en kısa sürede net teklif ile süreç bilgisini paylaşır.' },
    { key: 'page_desc_blog', value: 'Depolama stratejileri, paketleme teknikleri ve lojistik trendlerini blog yazılarımızda keşfedin.' },
    { key: 'page_desc_hizmetlerimiz', value: 'Depoda saklama, paketleme ve teslimat planlarımızı deneyimli ekibimizle uçtan uca yönetip her aşamada şeffaf raporluyoruz.' },
    { key: 'page_desc_sss', value: 'Depolama süresi, sigorta kapsamı ve teslimat planlarıyla ilgili sık sorulan soruları açıklayıcı şekilde yanıtladık.' },
    { key: 'page_desc_referanslar', value: 'Tamamlanan depolama projeleri ve müşteri yorumları, Level Nakliyat’ın güvenlik ve şeffaflık odaklı yaklaşımını gösterir.' },
    { key: 'page_desc_teklif_al', value: 'Depolama sürenize ve alan ihtiyacınıza göre hızlı, net ve size özel fiyat teklifi alın.' },
    { key: 'page_desc_galeri', value: 'Depolarımızın güvenlik altyapısını ve operasyon süreçlerimizi anlatan görselleri inceleyin.' },
    { key: 'page_desc_hizmet_bolgeleri', value: 'Depolama ve teslimat ağı sunduğumuz şehir ve ilçeleri keşfedin.' },
